...
run_btc_prune_node() {
    ...
    bitcoind -datadir=$max_disk_path/btc-data
}

check_btc_prune_node_block_height() {
    source ~/.bashrc
    bitcoin-cli -rpcuser=your-rpc-user -rpcpassword=your-rpc-password getblockchaininfo
}

check_btc_prune_node_log() {
    source ~/.bashrc
...
This script is completely free and open source, developed by Twitter user ${Green_font_prefix}@ouyoung11${Font_color_suffix} forked by Purson.
 ———————————————————————
 ${Green_font_prefix} 1. Install Btc prune node environment ${Font_color_suffix}
 ${Green_font_prefix} 2. Run Btc prune node ${Font_color_suffix}
 ${Green_font_prefix} 3. Check Btc prune node block height ${Font_color_suffix}
 ${Green_font_prefix} 4. Check Btc prune node logs ${Font_color_suffix}
 ———————————————————————" && echo
